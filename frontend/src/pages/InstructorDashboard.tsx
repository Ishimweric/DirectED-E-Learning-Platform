    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-gray-600">Here's what's happening with the courses you've published.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-2xl font-bold">{stats.avgCourseRating.toFixed(1)}</p>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {courses.map(course => (
                    <tr key={course._id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-gray-900">{course.totalStudents}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-gray-900">{course.recentEnrollments}</div>
                      </td>
                    </tr>
                  ))}
                </tbody>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Update your instructor profile</p>
            </div>
          </Link>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Add assessments to your courses</p>
            </div>
          </Link>
        </div>
      </div>
