    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link 
            to="/create-course"
            className="bg-white duration-300 dark:bg-gray-950 hover:scale-105 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow"
          >
          ...
          <Link 
            ...
            className="bg-white hover:scale-105 duration-300 dark:bg-gray-950 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow"
          >
            <div className="text-center">
          ...
          <Link 
            to="/create-quiz"
            className="bg-white hover:scale-105 dark:bg-gray-950 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300"
          >
            <div className="text-center">
